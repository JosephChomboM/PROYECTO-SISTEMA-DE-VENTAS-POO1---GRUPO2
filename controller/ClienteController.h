...
Cliente ClienteController::buscarPorCodigoCliente(int codigoCliente)
{
	...
	{
		if (codigoCliente == vectorCliente[i].getCodCliente())
		{
...
void ClienteController::listarCliente()
{
    for (int i = 0; i < vectorCliente.size(); i++)
    {
        cout    << setw(7) << left << vectorCliente[i].getCodCliente()
                << setw(12) << left << vectorCliente[i].getDniCliente()
                << setw(10) << left << vectorCliente[i].getNombreCliente()
                << setw(10) << left << vectorCliente[i].getApellidoCliente()
                << vectorCliente[i].getDireccionCliente() << endl;
    }
}
